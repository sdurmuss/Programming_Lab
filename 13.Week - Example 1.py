...
print(plt.imshow(im_1))#resmi yazdýr
plt.show()


"""im_1 = im_1 + 50 #renk degerlerini 50 birim artirdik- broadcasting
im_1[:,:,0] = im_1[:,:,0] + 50 #kýrýmýzý degerini 10 artir
im_1[:,:,0] = im_1[:,:,0] = 0 #kýrýmýzý degerini 0 yap
...
print(plt.subplot(1, 2, 1))#1 e 2 lik yere yazdýr
print(plt.imshow(im_1))
...
def my_norm(my_v):
    return int(((my_v[0]**2) + (my_v[1]**2) + (my_v[2]**2))**0.5) #a^2 + b^2 + c^2 kökünü aldýk
...
print(plt.imshow(im_2))
print(plt.subplot(1, 3, 2))#1 e 2 lik yere yazdýr
print(plt.imshow(im_2))
print(plt.subplot(1, 3, 3))
print(plt.imshow(im_3))

def my_norm_1(my_v):
    s = int(((my_v[0]**2) + (my_v[1]**2) + (my_v[2]**2))**0.5) #a^2 + b^2 + c^2 kökünü aldýk
    if(s > 130):
        return 1
    else:
        return 0
...
print(plt.imshow(im_2))
print(plt.subplot(1, 4, 2))#1 e 2 lik yere yazdýr
print(plt.imshow(im_2))
